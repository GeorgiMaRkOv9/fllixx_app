...
// Clear previus results
  ...
  <div class="card-body">
    ...
    <p class="card-text">
      <small class="text-muted">Release: ${global.search.type === 'movie' ? result.release_date : result.first_air_ddate}</small>
    </p>
  </div>
`;
...
// Show error alert when empty string is given in the searh bar
